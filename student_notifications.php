...
<!-- Mirrored from gambolthemes.net/html-items/cursus-new-demo/student_notifications.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jun 2024 15:30:30 GMT -->
<head>
		<meta charset="utf-8">
		...
		<title>Libis- Notifications</title>
		...
		<div class="left_section menu_left" id="js-menu" >
			<div class="left_section">
				<ul>
					...
					<li class="menu--item">
						<a href="student_courses.php" class="menu--link" title="Courses">
					...
					<li class="menu--item">
						<a href="student_notifications.php" class="menu--link active" title="Subscriptions">
    ...
    while ($author = $result_authors->fetch_assoc()) {
		...
		echo '<div class="col-xl-3 col-lg-4 col-md-6">
            <div class="fcrse_1 mt-30">
                <div class="tutor_img">
                    <a href="author_read.php?id=' . $author_id . '"><img src="images/left-imgs/img-1.jpg" alt=""></a>                                                
                </div>
...
<!-- Mirrored from gambolthemes.net/html-items/cursus-new-demo/student_notifications.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jun 2024 15:30:31 GMT -->
</html>